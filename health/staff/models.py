...
class RefundHistory(models.Model):
    ...
    oneday_cost = models.DecimalField(max_digits=10,blank=True, null=True, decimal_places=0 ,verbose_name='1일 이용료')
    used_period =  models.IntegerField(blank=True, null=True) # 사용한 기간('일'로 나옴)
    used_amount = models.DecimalField(max_digits=10,decimal_places=0, blank=True, null=True, default=0 ,verbose_name='이용료')
    total_utility_cost = models.DecimalField(max_digits=10,decimal_places=0, blank=True, null=True, default=0 ,verbose_name='총 이용료')
    refund_amount = models.DecimalField(max_digits=10,decimal_places=0, default=0 ,verbose_name='환급액')
